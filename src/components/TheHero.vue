<template>
	<section class="bg-tgtg text-gray-100 sm:p-16">
		<div class="container flex flex-col justify-center p-20 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
